...
class AnnotationTaggingFrame(annotation_frame.AnnotationFrame):
    ...
    def __init__(self, parent):
        ...
        self.short_directions.config(text = 'Tag the interesting areas by clicking, dragging, and releasing to put an annotation on the canvas.')
    ...
    def save_annotations(self):
        ...
        json.dump({'image_file': os.path.basename(self.image_name), 'annotations': annotations}, fp=open(save_file_name, 'w'), indent=4)
